...
export function Login() {
  ...
  function handleGoToCustomer() {
    navigation.navigate("CustomerStack", { screen: "Carregamento" });
  }
      ...
      >
        ...
        >
          ...
          <TouchableOpacity style={styles.forgot_password_link}>
            <Text style={styles.forgot_password_text}>Esqueci minha senha</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.google_button_text}>Entrar com o Google</Text>
          </TouchableOpacity>
