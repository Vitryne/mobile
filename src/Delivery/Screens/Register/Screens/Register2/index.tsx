...
import { DocumentUploadItem } from "../../Components/DocumentUploadItem.tsx/index";
...
export function Register2() {
  ...
  const [documents, setDocuments] = useState<Document[]>([
    { id: "cnh_front", label: "CNH (frente)", icon: "file-text", status: "pending" },
    { id: "cnh_back", label: "CNH (verso)", icon: "file-text", status: "pending" },
    { id: "crlv", label: "CRLV", icon: "credit-card", status: "pending" },
    { id: "address", label: "Comprovante de residência", icon: "home", status: "invalid" },
    { id: "selfie", label: "Selfie de verificação", icon: "user", status: "pending" },
  ]);
